...
import org.example.mysteryboxlearn.common.exception.SystemException;
import org.example.mysteryboxlearn.common.domain.vo.response.R;
import org.example.mysteryboxlearn.common.exception.AuthErrorCode;
...
@RestControllerAdvice // 让全局异常处理类中的方法返回值直接写入 HTTP 响应体中，常用于统一处理控制器层抛出的异常。
@Slf4j
