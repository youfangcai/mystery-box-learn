...
const emit = defineEmits<{ search: [value: CouponReceiveActivitySpec]; reset: [] }>()
const query = defineModel<CouponReceiveActivitySpec>('query', {required: true})
</script>
<template>
  <div class="search">
