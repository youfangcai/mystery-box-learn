...
<template>
  <div>
    ...
    >
      ...
      <el-table-column label="套餐名称" prop="name" show-overflow-tooltip sortable="custom" width="120">
      ...
      <el-table-column label="天数" prop="days" show-overflow-tooltip sortable="custom" width="120">
        <template v-slot:default="{row}:VipPackageScope">
          {{row.days}}
        </template>
      </el-table-column>
