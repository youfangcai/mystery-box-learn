  ...
  <div class="search">
    <el-form inline label-width="80" size="small">
      ...
      <el-form-item label="跳转类型">
        <dict-select v-model="query.navigatorType" :dict-id="DictConstants.NAVIGATOR_TYPE"></dict-select>
      </el-form-item>
      <el-form-item label="排序号">
        <el-input-number v-model="query.sort" controls-position="right"></el-input-number>
      </el-form-item>
      <el-form-item label="是否显示">
        <el-input-number v-model="query.valid" controls-position="right"></el-input-number>
      </el-form-item>
      <el-form-item label=" ">
