...
type CouponBoxRelScope = Scope<CouponBoxRelDto['CouponBoxRelRepository/COMPLEX_FETCHER_FOR_ADMIN']>
...
<template>
  <div>
    ...
    >
      ...
      <el-table-column label="盲盒" prop="boxId" show-overflow-tooltip sortable="custom" width="120">
