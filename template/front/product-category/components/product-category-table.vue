...
type ProductCategoryScope = Scope<ProductCategoryDto['ProductCategoryRepository/COMPLEX_FETCHER_FOR_ADMIN']>
const productCategoryTableHelper = inject(
    'productCategoryTableHelper',
    useTableHelper(api.productCategoryForAdminController.query, api.productCategoryForAdminController, {})
)
const {
  loadTableData,
  handleSortChange,
